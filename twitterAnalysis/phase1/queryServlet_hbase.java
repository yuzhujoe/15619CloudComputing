...
public class queryServlet extends HttpServlet {
	...
	private static HashMap<String, String> hashmap_hbase = new HashMap<String, String>();
	...
	public void doGet(HttpServletRequest request,
		...
		if(querySplit.equals("q1")){
			...
			String result = hashmap_hbase.get(userIdTime);
			...
			if(result == null){
				...
				hashmap_hbase.put(userIdTime, dataStr);
				result = dataStr;
			}
